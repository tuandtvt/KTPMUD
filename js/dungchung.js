...
function timKiemTheoMa(list, ma) {
    console.log("timKiemTheoMa",list,ma)
    for (var l of list) {
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">by KTPMUD Tuan Tai</a> - All rights reserved © 2021 - Designed by
            <span style="color: #eee; font-weight: bold">Tuan Tai</span></p>
    </div>`);
}
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                ...
                <li>Thanh toán linh hoạt: tiền mặt, visa / master</li>
            
                <li>Khách tự bảo quản đồ cá nhân!</li>
                <li>Liên hệ theo số
                    <br>Hotline:
...
function checkLocalStorage() {
    if (typeof (Storage) == "undefined") {
        alert('Máy tính không hỗ trợ LocalStorage. Không thể lưu thông tin sân, khách hàng!!');
    } else {
