...
function phanTich_URL_chiTietSanPham() {
    ...
    s += addThongSo('Kích thước gôn', sanPhamHienTai.detail.camara);
    s += addThongSo('Lưới', sanPhamHienTai.detail.camaraFront);
...
function getDetailPromo(sp) {
    switch (sp.promo.name) {
        case 'tragop':
            ...
            return `Tặng 2 xô nước khi có thẻ thành viên ProVip`;
        ...
        case 'moiramat':
            return `Khách hàng sẽ được thuê bóng miễn phí trong 1 tháng.`;
